...
const ROUTES = [
  ...
  // 财务管理 -- 规则设置 -- 连续签到奖励规则
  {
    path: '/platform/lxqdRules',
    component: asyncComponent(() => import('container/finance/platform/lxqdRules/lxqdRules'))
  },
    {
        path: '/platform/lxqdRules/addedit',
        component: asyncComponent(() => import('container/finance/platform/lxqdRules/lxqdRules-addedit'))
    },
  // 财务管理 -- 规则设置 -- 商城分销规则设置
  {
